...
namespace SimpleForumApp.Persistence.Migrations
{
    ...
    [Migration("20240714100948_mig_6")]
    partial class mig_6
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SimpleForumApp.Domain.Entities.Auth.ClaimBusinessRule", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.Property<long>("ExecutionOrderId")
                        .HasColumnType("bigint");
                    ...
                    b.ToTable("ClaimBusinessRules");
                });

            modelBuilder.Entity("SimpleForumApp.Domain.Entities.Auth.EndPointClaimBusinessRule", b =>
                {
                    b.Property<long>("EndPointId")
                        .HasColumnType("bigint");

                    b.Property<long>("ClaimBusinessRuleId")
                        .HasColumnType("bigint");
                    ...
                    b.HasKey("EndPointId", "ClaimBusinessRuleId");

                    b.HasIndex("ClaimBusinessRuleId");

                    b.HasIndex("StatusId");

                    b.ToTable("EndPointClaimBusinessRules");
                });
            ...
            modelBuilder.Entity("SimpleForumApp.Domain.Entities.Auth.PageClaimBusinessRule", b =>
                {
                    ...
                    b.HasKey("PageId", "ClaimBusinessRuleId");

                    b.HasIndex("ClaimBusinessRuleId");

                    b.HasIndex("StatusId");

                    b.ToTable("PageClaimBusinessRules");
                });

            modelBuilder.Entity("SimpleForumApp.Domain.Entities.Auth.PagePermission", b =>
                {
                    b.Property<long>("PageId")
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("SimpleForumApp.Domain.Entities.Core.ActionType", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("SimpleForumApp.Domain.Entities.Core.ExecutionOrder", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("SimpleForumApp.Domain.Entities.Core.Page", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("SimpleForumApp.Domain.Entities.Core.Status", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("SimpleForumApp.Domain.Entities.App.Action", b =>
                {
                    b.HasOne("SimpleForumApp.Domain.Entities.Core.Status", "Status")
                        .WithMany("Actions")
            ...
            modelBuilder.Entity("SimpleForumApp.Domain.Entities.Auth.ClaimBusinessRule", b =>
                {
                    b.HasOne("SimpleForumApp.Domain.Entities.Core.ExecutionOrder", "ExecutionOrder")
                        .WithMany("ClaimBusinessRules")
            ...
            modelBuilder.Entity("SimpleForumApp.Domain.Entities.Auth.EndPointClaimBusinessRule", b =>
                {
                    b.HasOne("SimpleForumApp.Domain.Entities.Auth.ClaimBusinessRule", "ClaimBusinessRule")
                        .WithMany("EndPoints")
                        .HasForeignKey("ClaimBusinessRuleId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
                    ...
                    b.HasOne("SimpleForumApp.Domain.Entities.Core.Status", "Status")
                        .WithMany("EndPointClaimBusinessRules")
                        .HasForeignKey("StatusId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.Navigation("ClaimBusinessRule");
            ...
            modelBuilder.Entity("SimpleForumApp.Domain.Entities.Auth.PageClaimBusinessRule", b =>
                {
                    ...
                    b.HasOne("SimpleForumApp.Domain.Entities.Core.Page", "Page")
                        .WithMany("ClaimBusinessRules")
                    ...
                    b.HasOne("SimpleForumApp.Domain.Entities.Core.Status", "Status")
                        .WithMany("PageClaimBusinessRules")
                        .HasForeignKey("StatusId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("SimpleForumApp.Domain.Entities.Traceability.EndPoint", b =>
                {
                    b.HasOne("SimpleForumApp.Domain.Entities.Core.ActionType", "ActionType")
                        .WithMany("EndPoints")
            ...
            modelBuilder.Entity("SimpleForumApp.Domain.Entities.Core.ExecutionOrder", b =>
                {
                    b.Navigation("ClaimBusinessRules");
                });
            ...
            modelBuilder.Entity("SimpleForumApp.Domain.Entities.Core.Status", b =>
                {
                    ...
                    b.Navigation("EndPointClaimBusinessRules");
                    ...
                    b.Navigation("PageClaimBusinessRules");
